<div class="item-product warehouse-import-row">
    ...
    <div class="warehouse-import-col">
        <input type="number" class="form-control" name="items[{{ $index }}][quantity]" min="1" value="1" placeholder="SL" required>
    </div>
    <div class="warehouse-import-col warehouse-import-action">
        <button type="button" class="btn btn-danger btn-sm remove-offline-row" title="Xóa dòng"><i class="fas fa-times"></i></button>
    </div>
</div>
